...
<br></br>
<form id="buscador-eventos" action="<?php echo url_for('bandejaEntrada/buscar') ?>" method="post">
	<h2 class="titulo" style="margin-left:10px; margin-top:2px; margin-right:10px; float:left;">Buscador usuario</h2>

...
<h1 style="text-align: center">Que dicen tus amigos</h1>
<div style="text-align: center;">
      ...
      <?php echo link_to(image_tag('iconos/mundo.png').'Que dices a los demas', 'publicacionMuro/indexTuPublicado', array('title' => 'Que has publicado')) ?>

</div>
<?php include_partial('publicacionMuro/buscadorAmigos', array('fecha'=> $fecha, 'query' => $query)); ?>

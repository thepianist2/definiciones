...
<?php echo link_to(image_tag('iconos/prueba.gif','class=imageMenuEstudiar').'<br>Realizar exámen', 'estudiar/prueba', array('title' => 'Realizar prueba de todas las palabras')) ?>

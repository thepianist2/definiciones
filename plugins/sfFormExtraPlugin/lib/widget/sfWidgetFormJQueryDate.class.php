...
class sfWidgetFormJQueryDate extends sfWidgetForm
{
  ...
  protected function configure($options = array(), $attributes = array())
  {
    ...
    //añadir los js
    sfContext::getInstance()->getResponse()->addJavascript('/sfJqueryReloadedPlugin/js/jquery-1.3.2.min.js', 'first');
    sfContext::getInstance()->getResponse()->addJavascript('/sfJqueryReloadedPlugin/js/plugins/jquery-ui-1.7.3.custom.min.js', 'last');
    sfContext::getInstance()->getResponse()->addStylesheet('/sfJqueryReloadedPlugin/css/ui-lightness/jquery-ui-1.7.3.custom.css', 'last');

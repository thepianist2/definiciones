...
/**
 * BandejaSalida form base class.
 *
 * @method BandejaSalida getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseBandejaSalidaForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('bandeja_salida[%s]');

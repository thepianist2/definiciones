...
/**
 * BandejaSalida filter form base class.
 *
 ...
 */
abstract class BaseBandejaSalidaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('bandeja_salida_filters[%s]');

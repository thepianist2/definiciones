...
    geocoder.geocode({ 'address': address}, geocodeResult2);
});
     ...
     var marcador = new google.maps.Marker({
        ...
        google.maps.event.addListener(marcador, 'click', function() {
          ...
          map.setCenter(marcador.getPosition());
                ...
                //evento click para el marcado
        google.maps.event.addListener(marcador, 'dblclick', function() {
            
            ver('<?php echo url_for('piso/showPorDireccion?direccion=') ?>'+ direccion);

...
<h1 style="text-align: center">Que le dicen a: <?php echo $usuario->getUserName(); ?></h1>
...
<?php include_partial('publicacionMuro/buscadorEntraMuro', array('fecha'=> $fecha, 'query' => $query)); ?>
...
<form id="publicar" action="<?php echo url_for('publicacionMuro/nuevaOtroMuro') ?>" method="post">

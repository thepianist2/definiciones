...
<h1 style="text-align: center;">Quién te ha agregado</h1>
<?php } ?>
<br>
...
<br></br>
<?php include_partial('amigo/buscadorSolicitudes', array('query' => $query)); ?>
<br></br>
<br></br>
     ...
     <div style="text-align: right;">
            <?php
					...
					if (Doctrine_Core::getTable('sfGuardUser')->saberEsAmigo($sf_user->getGuardUser()->getId(), $usuario->id)) {
						$imagen_fav .= '>';
						$imagen_fav .= image_tag('/images/iconos/amigo.png', array("id" => 'imagen_fav_' . $usuario->id,"class" => 'favoritos'));
					} else {

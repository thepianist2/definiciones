...
/**
 * BandejaEntrada filter form base class.
 *
 ...
 */
abstract class BaseBandejaEntradaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'idUsuarioRemitente' => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      'idUsuarioRemitente' => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
    ...
    $this->widgetSchema->setNameFormat('bandeja_entrada_filters[%s]');
